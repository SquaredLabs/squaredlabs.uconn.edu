<template>
  <div ref="view">
    ...
    >
      ...
      >
        <div id="pixelsPerDay" class="graphicInner">
          <img
      ...
      <div
        ...
        @mouseleave="endCounter"
      >
        <div id="covfefe" class="graphicInner">
          <img
      ...
      <div class="graphic">
        <div id="icons" class="graphicInnerI">
          ...
          <div class="graphicIcon">
            <div id="icon4" class="graphicIconI">...</div>
          </div>
        </div>
      </div>
      <div id="moreStuff" class="graphic">
        <div class="graphicInner">&nbsp;</div>
      </div>
    </div>
    <v-link id="graphicLeft" class="arrow" @click="graphicLeft"> ← </v-link>
    <v-link id="graphicRight" class="arrow" @click="graphicRight"> → </v-link>
  </div>
</template>
  ...
  methods: {
    ...
    async getRepos() {
      const response = await this.$http.get(
        "https://api.github.com/users/squaredlabs"
      )
