...
<script>
/*
    A helper component that makes it much easier to use the Layout component
    m - Margin (vertical / horizontal)
    s - Size (quarter/third/half/pacman/whole) (default: quarter)
    c - Children layout (centered/spaced)
    p - Padded (true/false)
*/
export default {
  props: ["m", "s", "c", "p"]
