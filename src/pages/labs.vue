<template>
  <Grid class="noMarginTop">
      ...
      <div id="titleText">
        <TitleLine title-positioning="design">
          ...
          <template slot="hoverContent">
            <p>
              <span class="weAre">you wouldn&rsquo;t build</span>
        ...
        <TitleLine title-positioning="create">
          ...
          <template slot="hoverContent">
            ...
            <p>
              <span class="weAre">&ldquo;create&rdquo; is about</span>
    ...
    <div
      ...
      <div>
        <p>
          <span class="weAre">we are squared labs:</span> a group of undergratuate students at the University of Connecticut. We support research at the University and bring the sciences and arts closer together.
        </p>
        <p>
          <span class="weAre">we are collaborators:</span> programmers, designers, illustrators, photographers, journalists, and scientists.
        </p>
        <p>
          <span class="weAre">we create and build</span> tools, websites, identities, art, and more. Really, the only thing we don’t do is say no.
        </p>
      </div>
    </div>
    <div
    ...
    <div
      ...
      <p>
        ...
        (and past) squared labs team members see our people page.
      </p>
      <p>
      ...
      <div>
        ...
        <div class="subsection">
          ...
          <p>
            ...
            <span class="stylizedName">[squared labs]</span> on the front and looks like some sort of
            company (we’re not).
          </p>
        </div>
        <p>
