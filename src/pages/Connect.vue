            ...
            <div class="graphic" >
              <div class="graphicInnerI" id="icons">
                <div class="graphicIcon">
                  ...
                  v-on:mouseover="startCounter(commits)" 
                  v-on:mouseleave="endCounter">
...
<script>
  ...
  export default {
    data(){
      ...
      return{statCount:0,repos:0,commits:0,size:30}
    },
    methods:{
      startCounter(max){
      ...
      getRepos(){
        this.$http.get('https://api.github.com/users/squaredlabs').then(response => {
      ...
      getCommitsAndSize(){
        this.$http.get('https://api.github.com/orgs/squaredlabs/repos').then(response => {
      ...
      getCommitsPerRepo(url){
        this.$http.get(url+'/stats/participation').then(response => {
            this.commits+= response.body.all.reduce((a,b)=>a+b, 0);
          }, response => {
            this.commits+=15;
            console.error(`Could not load ${url+'/stats/participation'}: ${JSON.stringify(response)}`);
        });
      },
      getSize(){
        this.$http.get('https://api.github.com/orgs/squaredlabs/repos').then(response => {
